...
public class MongoDBConnection implements DBConnection{
	...
	@Override
	    public void setVisitedRestaurants(String userId, List<String> businessIds) {
	   		db.getCollection("users").updateOne(new Document("user_id", userId),//if user_id = userid
	   			 //pushall将新的userID传入new document中
    ...
    public JSONObject getRestaurantsById(String businessId, boolean isVisited) {
   	 ...
   	 FindIterable<Document> iterable = db.getCollection("restaurants").find(
   			 eq("business_id", businessId)); //where...==
   	 try {
...
//推荐算法相同，可与mysql部分用abstract class
	@Override
    ...
    public Set<String> getBusinessId(String category) {
   	 ...
   	 //regex 等于 MySQL的like，“chinese”,"korean"
